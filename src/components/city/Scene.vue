...
// 导入场景
import scene from "@/three/city/scene";
// 导入相机
import camera from "@/three/city/camera";
// 导入控制器
import controls from "@/three/city/controls";
// 导入辅助坐标轴
import axesHelper from "@/three/city/axesHelper";
// 导入渲染器
import renderer from "@/three/city/renderer";
// 初始化调整屏幕
import "@/three/city/init";
// 导入添加物体函数
import createMesh from "@/three/city/createMesh";
// 导入每一帧的执行函数
import animate from "@/three/city/animate";
import AlarmSprite from "@/three/city/mesh/AlarmSprite";
import LightWall from "@/three/city/mesh/LightWall";
import FlyLineShader from "@/three/city/mesh/FlyLineShader";
import LightRadar from "@/three/city/mesh/LightRadar";
